...
const generateAccessAndRefreshTokens = async(userId) => {
    try {
        ...
        throw new ApiError(500, "Something went wong while generating acess and refresh token")
    }
}
...
const logoutUser = asyncHandler(async(req,res) => {
    await User.findByIdAndUpdate(
        ...
        {
            $unset: {
                refreshToken: 1 // tnis removes the field from the document
            }
        },
            {
                new: true
...
const updateAccountDetails = asyncHandler(async(req,res) => {
    ...
    return res
    .status(200)
    .json(new ApiResponse(200, "Account details updated successsfully"))
});
